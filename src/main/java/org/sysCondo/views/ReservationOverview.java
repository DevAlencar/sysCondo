...
public class ReservationOverview extends JPanel {
    ...
    public ReservationOverview() {
        ...
        allReservations = bookingController.getAllBookings();
    ...
    public void updateTable() {
        ...
        for (Booking booking : allReservations) {
            tableModel.addRow(new Object[]{
                    ...
                    booking.getUserBookingFk().getUserName(), // solicitante
                    booking.getCommonAreaBookingFk().getCommonAreaName(), // área
                    booking.getBookingDateTime(), // data
                    booking.getBookingStatus() // status
                    /*booking.getSolicitante(),
                    booking.getArea(),
                    booking.getData(),
                    booking.getStatus()*/
            });
    ...
    public void updateTableByArea(String areaName) {
        ...
        List<Booking> filteredReservations = new ArrayList<>();

        // Filter reservations by area
        for (Booking reservation : allReservations) {
            if (reservation.getCommonAreaBookingFk().getCommonAreaName().equalsIgnoreCase(areaName)) {
                filteredReservations.add(reservation);
            }
        }

        // Sort the filtered reservations by area name
        // filteredReservations.sort(Comparator.comparing(Booking::getCommonAreaBookingFk.getCommonAreaName)); FIXME

        // Populate the table with sorted reservations
        for (Booking booking : filteredReservations) {
            tableModel.addRow(new Object[]{
    ...
    public static void main(String[] args) {
        ...
        SwingUtilities.invokeLater(() -> {
            ...
            frame.add(new ReservationOverview());
